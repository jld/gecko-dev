...
class SharedMemory final {
 ...
 public:
  ...
  MOZ_MUST_USE bool Create(size_t size) {
    return CreateInternal(size, FreezeCap::NONE);
  }
  ...
  // Returns true on success, false on failure.
  MOZ_MUST_USE bool CreateFreezeable(size_t size) {
    return CreateInternal(size, FreezeCap::FREEZE);
  }
