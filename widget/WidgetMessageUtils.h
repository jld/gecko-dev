                               ...
                               mozilla::LookAndFeel::IntID::End>
{
  ...
  static_assert(static_cast<IdType>(mozilla::LookAndFeel::IntID::CaretBlinkTime) == IdType(0));
};
                               ...
                               mozilla::LookAndFeel::ColorID::End>
{
  ...
  static_assert(static_cast<IdType>(mozilla::LookAndFeel::ColorID::WindowBackground) == IdType(0));
};
