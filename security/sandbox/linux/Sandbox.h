...
// Whether a given type of sandboxing is available.  The enum can be
// used as a boolean indicating whether the corresponding Set*Sandbox
...
MOZ_EXPORT SandboxAvailability CanSandboxMediaPlugin();
MOZ_EXPORT void SetMediaPluginSandbox(const char *aFilePath);
#else
static inline SandboxAvailability CanSandboxMediaPlugin()
{
  return kSandboxingDisabled;
}
