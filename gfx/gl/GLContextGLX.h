...
class GLContextGLX : public GLContext {
 public:
  ...
  static already_AddRefed<GLContextGLX> CreateGLContext(
      const GLContextDesc&, std::shared_ptr<GLXDisplay> display,
 ...
 private:
  ...
  GLContextGLX(const GLContextDesc&, std::shared_ptr<GLXDisplay> aDisplay,
  ...
  const std::shared_ptr<GLXDisplay> mDisplay;
