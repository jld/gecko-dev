...
XlibDisplay::Ref GLXLibrary::GetDisplay() {
  XlibDisplay::Ref display;
...
already_AddRefed<GLContextGLX> GLContextGLX::CreateGLContext(
    const GLContextDesc& desc, XlibDisplay::Ref display, GLXDrawable drawable,
...
GLContextGLX::GLContextGLX(const GLContextDesc& desc, XlibDisplay::Ref aDisplay,
