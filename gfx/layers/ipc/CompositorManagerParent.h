...
public:
  ...
  mozilla::ipc::IPCResult RecvAddSharedSurface(wr::ExternalImageId&& aId,
                                               SurfaceDescriptorShared&& aDesc) override;
  mozilla::ipc::IPCResult RecvRemoveSharedSurface(wr::ExternalImageId&& aId) override;
